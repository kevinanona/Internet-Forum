...
$sql = "SELECT creator_username, f_title, f_text, forum_subject_id, tag FROM Forum ORDER BY f_timestamp DESC";
...
echo		"</DIV>";
echo		"<DIV class=subjectAndTag> Subject: $subjectCol[$i] , Tag: $tagCol[$i]";
echo		"</DIV>";
